      ...
      body: CustomScrollView(
        slivers: [
          ...
          SliverList(
            ...
            for (int i = 0; i < 5; i++)
              ListTile(
                title: Text("SliverList SliverChildListDelegate: $i"),
              )
          ])),
          SliverList(
            delegate: SliverChildBuilderDelegate(
                (context, index) => ListTile(
                      title: Text(
                          "SliverList SliverChildBuilderDelegate : $index"),
                    ),
                childCount: 5),
          ),
              ...
              delegate: SliverChildListDelegate([
                for (int i = 0; i < 5; i++)
                  Padding(
                    ...
                    child: ListTile(
                      title: Text("SliverFIxedExtentList : $i"),
                    ),
                  )
              ]),
              itemExtent: 30),
          SliverGrid(
              delegate: SliverChildBuilderDelegate((context, index) {
                return Container(
                    ...
                    child: ListTile(
                      title: Text(
                          "SliverGrid SliverChildBuilderDelegate : $index "),
                    ));
              }, childCount: 7),
